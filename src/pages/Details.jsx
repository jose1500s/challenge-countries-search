...
export default function Details() {
    ...
    return (
        <div className="container-details">
            <button className="ml-6 mt-3 disabled:opacity-50 transition inline-flex items-center justify-center space-x-1.5 border focus:outline-none focus:ring-2 focus:ring-offset-2 focus:z-10 shrink-0 saturate-[110%] border-slate-300 focus:ring-slate-500 bg-white text-slate-900 hover:bg-slate-50 px-4 py-1.5 text-lg font-medium rounded-md"
                onClick={() => navigate('/')}
            >
